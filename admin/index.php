              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php $dokter_query = mysqli_query($con, "SELECT COUNT(*) FROM tb_dokter");
                                    $hasil_dokter = $dokter_query->fetch_array(MYSQLI_NUM);
                                    $dokter = $hasil_dokter[0];?>
                    <div class="ps-3">
                      <h6><?= $dokter ?></h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php $klinik_query = mysqli_query($con, "SELECT COUNT(*) FROM tb_klinik");
                                    $hasil_klinik = $klinik_query->fetch_array(MYSQLI_NUM);
                                    $klinik = $hasil_klinik[0];?>
                    <div class="ps-3">
                    <h6><?= $klinik ?></h6>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <?php $pasien_query = mysqli_query($con, "SELECT COUNT(*) FROM tb_pasien");
                                    $hasil_pasien = $pasien_query->fetch_array(MYSQLI_NUM);
                                    $pasien = $hasil_pasien[0];?>
                    <div class="ps-3">
                    <h6><?= $pasien ?></h6>
