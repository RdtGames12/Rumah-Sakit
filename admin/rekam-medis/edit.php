                    ...
                    <div class="col-md-10 center">
                        <div class="card shadow-sm">
                            <div class="card-body b-b">
                                ...
                                <?php
                                                        $id = $_GET['id'];
                                                        $sql_rm = mysqli_query($con, "SELECT * FROM tb_rekammedis WHERE id_rekammedis = '$id'") or die (mysqli_error($con));
                                                        $data = mysqli_fetch_array($sql_rm);
                                                        ?>
                                <form class="form-material" action="proses.php?id=<?= $id ?>" method="post">
                                    <!-- Input -->
                                    <div class="body">
                                        <h6>Pasien</h6>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input name="keluhan" id="keluhan" class="form-control" value="<?=$data['keluhan']?>" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input name="diagnosa" id="diagnosa" class="form-control" value="<?=$data['diagnosa']?>" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
