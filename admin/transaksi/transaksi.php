...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" href="index.html">
                ...
                <div class="col-md-8 center">
                    <div class="card shadow-sm">
                        <div class="card-body b-b">
                            ...
                            <form class="form-material" action="transaksi.php?id=<?=$id?>" method="post">
                                <!-- Input -->
                                <div class="body">
                                    <h6>Biaya</h6>
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" name="tarif" id="tarif" class="form-control" value="<?= $biaya ?>" autofocus required disabled />
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" name="pasien" id="pasien" class="form-control" value="<?= $pasien ?>" autofocus required disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if ($bayar  == 0) { ?>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="number" name="bayar" id="bayar" min="<?= $biaya ?>" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                   <?php }else {
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="number" name="bayar" id="bayar" min="1" value="<?= $bayar ?>" class="form-control" disabled required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  <?php } ?>
                                    ...
                                    <div class="row clearfix">
                                        <div class="center">
                                            <input type="submit" name="proses" value="Simpan" class="btn btn-primary mt-2">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" name="kembalian" id="kembalian" class="form-control" autofocus required disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                   <?php }else {
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="number" name="kembalian" id="kembalian" min="1" value="<?= $kembalian ?>"class="form-control" required disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
