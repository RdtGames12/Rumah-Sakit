                                    ...
                                    <div class="body">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="nama_dokter" id="nama_dokter" class="form-control" value="<?=$data['nama_dokter']?>" autofocus required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="spesialis" id="spesialis" class="form-control" value="<?=$data['spesialis']?>" autofocus required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
