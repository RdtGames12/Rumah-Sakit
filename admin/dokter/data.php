                    ...
                    <div class="card my-3 no-b">
                        ...
                        <div class="card-body">
                            <table class="table cell-vertical-align-middle  table-responsive mb-4">
                                ...
                                <tr class="no-b">
                                    <td>
                                        <a href="add.php" type="button" class="btn btn-success btn-sm">Tambah Dokter</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <table id="datatables-button" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><a href="details.php?id=<?=$data['id_dokter']?>" class="btn btn-link btn-sm">Lihat Detail</a></td>
                                    <td>
                                        <a href="delete.php?id=<?=$data['id_dokter']?>" onclick="return confirm('apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm text-white"><i class="glyphicon glyphicon-trash">HAPUS</i></a>
                                    </td>
                                    <?php
                                    }
                                    ?>
